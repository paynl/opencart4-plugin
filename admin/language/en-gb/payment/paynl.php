...
$_['text_pm_allowed_shipping'] = 'Limit shipping methods';
$_['text_pm_customer_type'] = 'Customer Type';
$_['text_pm_customer_type_both'] = 'Both (B2C & B2B)';
$_['text_pm_customer_type_private'] = 'Private (B2C)';
$_['text_pm_customer_type_business'] = 'Business (B2B)';
...
$_['tooltip_pm_allowed_shipping'] = 'Select which shipping methods this method should be available for. Hold CTRL button to select/deselect multiple';

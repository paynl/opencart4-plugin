...
use PayNL\Sdk\Packages\Psr\Http\Message\UploadedFileInterface;
/**
 ...
 */
class ServerRequest extends \PayNL\GuzzleHttp\Psr7\Request implements \PayNL\Sdk\Packages\Psr\Http\Message\ServerRequestInterface
{
    /**
     * @var array
     */
    ...
    public static function normalizeFiles(array $files)
    {
        ...
        foreach ($files as $key => $value) {
            if ($value instanceof \PayNL\Sdk\Packages\Psr\Http\Message\UploadedFileInterface) {

 ...
 */
class FnStream implements \PayNL\Sdk\Packages\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\PayNL\Sdk\Packages\Psr\Http\Message\StreamInterface $stream, array $methods)
    {

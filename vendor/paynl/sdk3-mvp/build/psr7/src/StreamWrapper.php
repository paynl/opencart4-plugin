...
class StreamWrapper
{
     ...
     */
    public static function getResource(\PayNL\Sdk\Packages\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\PayNL\Sdk\Packages\Psr\Http\Message\StreamInterface $stream)
    {

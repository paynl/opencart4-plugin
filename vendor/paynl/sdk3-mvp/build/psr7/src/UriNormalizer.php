...
final class UriNormalizer
{
     ...
     */
    public static function normalize(\PayNL\Sdk\Packages\Psr\Http\Message\UriInterface $uri, $flags = self::PRESERVING_NORMALIZATIONS)
    {
     ...
     */
    public static function isEquivalent(\PayNL\Sdk\Packages\Psr\Http\Message\UriInterface $uri1, \PayNL\Sdk\Packages\Psr\Http\Message\UriInterface $uri2, $normalizations = self::PRESERVING_NORMALIZATIONS)
    {
        return (string) self::normalize($uri1, $normalizations) === (string) self::normalize($uri2, $normalizations);
    }
    private static function capitalizePercentEncoding(\PayNL\Sdk\Packages\Psr\Http\Message\UriInterface $uri)
    {
        $regex = '/(?:%[A-Fa-f0-9]{2})++/';
    ...
    private static function decodeUnreservedCharacters(\PayNL\Sdk\Packages\Psr\Http\Message\UriInterface $uri)
    {

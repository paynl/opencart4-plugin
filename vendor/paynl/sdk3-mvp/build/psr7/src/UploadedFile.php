...
class UploadedFile implements \PayNL\Sdk\Packages\Psr\Http\Message\UploadedFileInterface
{
    /**
     * @var int[]
     */
    ...
    private function setStreamOrFile($streamOrFile)
    {
        ...
        } elseif ($streamOrFile instanceof \PayNL\Sdk\Packages\Psr\Http\Message\StreamInterface) {
    ...
    {
        $this->validateActive();
        if ($this->stream instanceof \PayNL\Sdk\Packages\Psr\Http\Message\StreamInterface) {
            return $this->stream;
        }
